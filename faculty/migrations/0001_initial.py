# Generated by Django 3.0.1 on 2019-12-27 13:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('effort', models.PositiveSmallIntegerField(blank=True, default=100, help_text='Percent of effort/responsibility the instructor is assigned', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(100)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hours', models.PositiveSmallIntegerField(blank=True, default=30, help_text='The number of instructional hours assigned to the advisor')),
                ('effort', models.PositiveSmallIntegerField(blank=True, default=100, help_text='Percent of effort/responsibility the advisor is assigned', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(100)])),
