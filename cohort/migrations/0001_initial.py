    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.DateField(help_text='Date that the cohort starts, e.g. the first day of Foundations')),
                ('end', models.DateField(help_text='Date that the cohort ends, e.g. the last day of Applied')),
            ],
            options={
                'db_table': 'cohorts',
                'ordering': ('-cohort',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cohort', models.ForeignKey(help_text='The cohort the capstone was completed in', on_delete=django.db.models.deletion.CASCADE, related_name='capstones', to='cohort.Cohort')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hours', models.PositiveSmallIntegerField(default=12, help_text='The number of hours in the course, e.g. the CEUs')),
