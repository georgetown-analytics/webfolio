    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('semester', models.CharField(blank=True, choices=[('SP', 'Spring'), ('SU', 'Summer'), ('FA', 'Fall')], help_text='The academic semester the course is in (uses cohort semester by default)', max_length=2)),
                ...
                ('cohort', models.ForeignKey(blank=True, default=None, help_text='The cohort that this course is a part of (if data science)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='cohort.Cohort')),
            ],
            options={
                'db_table': 'courses',
