    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(choices=[('A', 'A'), ('B', 'B'), ('C', 'C')], help_text='If multiple cohorts per semester, the semester section', max_length=1)),
                ('start', models.DateField(blank=True, help_text='Date that the cohort starts, e.g. the first day of Foundations', null=True)),
                ('end', models.DateField(blank=True, help_text='Date that the cohort ends, e.g. the last day of Applied', null=True)),
            ],
            options={
                'db_table': 'cohorts',
                'ordering': ('-cohort',),
